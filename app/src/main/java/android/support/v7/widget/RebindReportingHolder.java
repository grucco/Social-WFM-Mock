 ...
 * a {@link org.fingerlinks.mobile.android.utils.widget.recycleview.multiselector.MultiSelector},
 * use {@link org.fingerlinks.mobile.android.utils.widget.recycleview.multiselector.MultiSelectorBindingHolder}
 * instead.
 */
public abstract class RebindReportingHolder extends RecyclerView.ViewHolder {
    ...
    private final static int FLAG_CHANGED = 64;
};