...
public class SwappingHolder extends MultiSelectorBindingHolder implements SelectableHolder {
     ...
     * calling {@link org.fingerlinks.mobile.android.utils.widget.recycleview.multiselector.MultiSelector#setSelected(org.fingerlinks.mobile.android.utils.widget.recycleview.multiselector.SelectableHolder, boolean)}.</p>
    ...
    public void setActivated(boolean isActivated) {
        ...
        if (itemView instanceof CardView) {
            if (itemView.isActivated())
                ((CardView) itemView).setCardBackgroundColor(itemView
                        .getContext().getResources().
                                getColor(R.color.item_selected_color));
            else
                ((CardView) itemView).setCardBackgroundColor(itemView
                        .getContext().getResources().
                                getColor(R.color.item_unselected_color));
        } else {
