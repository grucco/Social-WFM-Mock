...
/**
 * <p>Public interface used by selectable items connected to {@link org.fingerlinks.mobile.android.utils.widget.recycleview.multiselector.MultiSelector}.</p>
 */
public interface SelectableHolder {
     ...
     * This can (and often will) change; if attached to a {@link org.fingerlinks.mobile.android.utils.widget.recycleview.multiselector.MultiSelector},
     * {@link org.fingerlinks.mobile.android.utils.widget.recycleview.multiselector.MultiSelector#bindHolder(SelectableHolder, int, long)}
